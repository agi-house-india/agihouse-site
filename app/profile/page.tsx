...
export const metadata = {
  title: 'My Profile | AGI House India',
  description: 'View and edit your AGI House India profile',
}
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="glassmorphism rounded-2xl p-8">
        ...
        {profile.bio && (
          <div className="py-6 border-b border-gray-700">
            ...
            <p className="text-secondary-white">{profile.bio}</p>
          </div>
        )}
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Link
          href="/members"
          className="glassmorphism rounded-xl p-6 hover:scale-[1.02] transition-transform"
        >
          <h3 className="text-lg font-semibold text-white mb-1">Browse Members</h3>
          <p className="text-secondary-white text-sm">Connect with other community members</p>
        </Link>
        <Link
          href="/events"
          className="glassmorphism rounded-xl p-6 hover:scale-[1.02] transition-transform"
        >
          <h3 className="text-lg font-semibold text-white mb-1">Upcoming Events</h3>
          <p className="text-secondary-white text-sm">Find events in your city</p>
        </Link>
      </div>
    </div>
  )
